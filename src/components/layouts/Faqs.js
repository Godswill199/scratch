...
const [faqQuestions, setFaqQuestions] = useState([
    ...
    , isActive: false },
     { id: 5, question: "What happens if I cheat the gaming system?", answer: "IF SCRATCH9JA DETECTIVE TEAM DETECTS ANY MANIPULATION ON THE CARD GAME; YOU WILL BE CALLED TO THE SCRATCHJA HEAD OFFICE TO PLAY THAT PARTICULAR GAME WHEREBY YOU HAVE TWO CHANCES TO TRY YOUR LUCK. OR, YOU'LL BE CALLED VIA VIDEO CALL AND GIVEN TWO CHANCES TO TRY YOUR LUCK REMOTELY. IF YOU WIN; ALL YOUR WINNINGS WILL BE CREDITED; ELSE YOU WON'T BE CREDITED. Signed and approved by the management. Note: If you can't accept these terms and conditions; Do NOT PLAY THE GAME."
   , isActive: false }
Note: If you can't accept these terms and condition; Do not play the game

Signed and approved by the management.
