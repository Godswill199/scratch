...
const GamesContextProvider = (props) => {
    ...
    const games = [
        ...
        {id: 2, image: game2, title: 'find the ball', price: 5000.00, category: 2, isNew: true, topPrize: "N50,000", isVerOrient: false,
        ...
        {id: 4, image: game4, title: 'Gadget Hunt', price: 3000.00, category: 1, isNew: false, topPrize: "N500,000", isVerOrient: true,
        desc: "Scratch only four circles to reveal gadgets, If you have four matching gadgets you win!"},

        {id: 5, image: game5, title: 'Seasons Greetings', price: 3000.00, category: 3, isNew: false, topPrize: "1,000,000", isVerOrient: true,
        desc: "Scratch only three(3) Christmas tree balls & win any amount you find!"},

        {id: 6, image: game6, title: 'Sure Banker', price: 2000.00, category: 3, isNew: false, topPrize: "N50,000", isVerOrient: true,
