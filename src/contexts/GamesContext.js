...
const GamesContextProvider = (props) => {
    ...
    const games = [
        ...
        {id: 4, image: game4, title: 'Gadget Hunt', price: 500.00, category: 1, isNew: false, topPrize: "N500,000", isVerOrient: true,
        desc: "Scratch only four circles to reveal gadgets, If you have four matching gadgets you win!"},

        {id: 5, image: game5, title: 'Seasons Greetings', price: 1000.00, category: 3, isNew: false, topPrize: "1,000,000", isVerOrient: true,
        ...
        {id: 7, image: game7, title: 'Jackpot', price: 1000.00, category: 3, isNew: false, topPrize: "N500,000", isVerOrient: true,
